...
#Implicit-> in Python, this automatically turns a data type to another data type

a = 12
b = 2
print(a/b) 

#Explicit -> In this, we use built-in functions for data type conversion
...
#2 Compound Assignment operator -> These are the shortcuts of the operator 
...
#1. and -> return true if all conditions are true 
